...
const EipsStatusCards = () => {
    ...
    return (
        ...
        <div className='grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mx-8'>
            <div className='bg-white font-bold shadow-[#FAEA10] shadow-lg flex justify-between items-center w-[250px] h-28 text-center px-4 py-2 gap-3 rounded-md transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-104 duration-200 ...'>
                <div className='w-1/2'>
